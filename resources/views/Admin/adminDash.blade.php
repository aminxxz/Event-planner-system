...
<!--route ('assign-role')-->
@extends('layouts.Master.adminView')
                        ...
                        <table id="commList" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$committees->position}}</td>
                                    <td><button class="btn btn-primary" data-toggle="modal" data-target="#assign-role-modal{{$committees->stud_id}}">Assign President</button></td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title">Assign Position</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="/assignPosition/{{$committees->stud_id}}" method="POST">
                                                @csrf
                                                <div class="col-sm-6">
                                                    <!-- select -->
